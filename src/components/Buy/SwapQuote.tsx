...
export function SwapQuoteDisplay({ quote, loading }: SwapQuoteDisplayProps) {
  if (loading) {
    return (
      <div className="bg-green-50 rounded-xl p-4 mb-6 animate-pulse">
        <div className="h-4 w-20 bg-green-100 rounded mb-2" />
        <div className="h-6 w-32 bg-green-100 rounded" />
      </div>
    );
  }
  ...
  return (
    <div className="bg-green-50 rounded-xl p-4 mb-6">
      <p className="text-xs text-green-600 mb-1">you will receive approximately</p>
