...
export default function SellPage() {
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          {step === 'success' && (
            <div className="text-center">
              <div className="size-20 bg-success-light dark:bg-success/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-success/20 dark:border-success/30">
                <CheckCircle className="size-10 text-success" />
              </div>
              <h2 className="text-2xl font-bold text-text-primary dark:text-[#F0F0F0] mb-2">Sell Successful!</h2>
          ...
          {step === 'error' && (
            <div className="text-center">
              <div className="size-20 bg-error-light dark:bg-error/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-error/20 dark:border-error/30">
          ...
          {['approve', 'swap', 'confirming'].includes(step) && (
            <div className="text-center">
              <div className="size-20 bg-gold-100 dark:bg-gold-500/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-gold-500/20 dark:border-gold-500/30">
  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      {/* Error Message */}
      {error && step === 'input' && (
        <div className="bg-error-light dark:bg-error/10 border border-error/30 text-error rounded-xl p-4 mt-4 flex items-start gap-2">
