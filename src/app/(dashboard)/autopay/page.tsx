    ...
    <div className="p-6 max-w-lg mx-auto min-h-screen">
      ...
      <FadeUp delay={0.12}>
        <motion.button
          ...
          className="w-full bg-gold-gradient text-[#1A1A1A] font-bold py-4 rounded-2xl text-base flex items-center justify-center gap-2 mb-8"
          whileTap={{ scale: 0.98 }}
      ...
      {/* AutoPay Cards List */}
      <StaggerContainer staggerDelay={0.06} delayChildren={0.2} className="space-y-3 mb-8">
